...
function priceRangeHint() {
	...
	if (categorySelected || categorySelected == "--Select Category--") {
		...
		if (count == 3) {
			document.getElementById('recommendPrice').textContent = "Recommended price for your Car's category : 1.000.000-1.500.000 VND/day ";
			if (priceSelected <= 1500 && priceSelected >= 1000) {
				document.getElementById('recommendPrice').textContent = "";
			}
		}
		if (count == 2) {
			document.getElementById('recommendPrice').textContent = "Recommended price for your Car's category : 700.000-999.000 VND/day ";
		...
		if (count == 1) {
			document.getElementById('recommendPrice').textContent = "Recommended price for your Car's category : 400.000-699.000 VND/day ";
			if (priceSelected <= 699 && priceSelected >= 400) {
				document.getElementById('recommendPrice').textContent = "";
			}
		}
		if (count == 0) {
			document.getElementById('recommendPrice').textContent = "Recommended price for your Car's category : 100.000-399.000 VND/day ";
...
function rangeInputItem(defaultPrice) {
	...
	deliveryCheck.addEventListener('change', function() {
		...
		if (this.checked) {
			...
			document.getElementById('deliveryDistanceValue').textContent = "Delivery Fee: " + new Intl.NumberFormat('vi-VN', config).format(defaultPrice * 1000 * deliveryDistanceRange.value / 10);
	...
	limitKmCheck.addEventListener('change', function() {
		if (this.checked) {
			...
			document.getElementById('maxKmValue').textContent = "Cleanning Fee: " + new Intl.NumberFormat('vi-VN', config).format(defaultPrice * 1000 * maxKmRange.value / 10);
			document.getElementById('overLimitFeeValue').textContent = "Decoration Fee: " + new Intl.NumberFormat('vi-VN', config).format(defaultPrice * 1000 * overLimitFeeRange.value / 10);
	...
	deliveryDistanceRange.addEventListener('input', function() {
		...
		const config = { style: 'currency', currency: 'VND', maximumFractionDigits: 9 }
		deliveryDistanceValue.textContent = "Delivery Fee: " + new Intl.NumberFormat('vi-VN', config).format(defaultPrice * 1000 * this.value / 10);
	});
	overLimitFeeRange.addEventListener('input', function() {

		const config = { style: 'currency', currency: 'VND', maximumFractionDigits: 9 }
		overLimitFeeValue.textContent = "Decoration Fee: " + new Intl.NumberFormat('vi-VN', config).format(defaultPrice * 1000 * this.value / 10);
	});
	maxKmRange.addEventListener('input', function() {

		const config = { style: 'currency', currency: 'VND', maximumFractionDigits: 9 }
		maxKmValue.textContent = "Cleanning Fee: " + new Intl.NumberFormat('vi-VN', config).format(defaultPrice * 1000 * this.value / 10);
	}
	);
}
...
function priceRentCheck() {
	...
	document.getElementById('priceRent').addEventListener('input', function() {
		rangeInputItem(this.value);
		if (this.value < 1 || this.value % 1 !== 0) {
			priveValue.textContent = "";
		}
		else {


			const config = { style: 'currency', currency: 'VND', maximumFractionDigits: 9 }
			priveValue.textContent = "Your price: " + new Intl.NumberFormat('vi-VN', config).format(this.value * 1000);
			if (deliveryCheck.checked) {

				document.getElementById('deliveryDistanceValue').textContent = "Delivery Fee: " + new Intl.NumberFormat('vi-VN', config).format(this.value * 1000 * deliveryDistanceRange.value / 10);
			}
			if (limitKmCheck.checked) {
				document.getElementById('maxKmValue').textContent = "Cleanning Fee: " + new Intl.NumberFormat('vi-VN', config).format(this.value * 1000 * maxKmRange.value / 10);
				document.getElementById('overLimitFeeValue').textContent = "Decoration Fee: " + new Intl.NumberFormat('vi-VN', config).format(this.value * 1000 * overLimitFeeRange.value / 10);
			}
		}
